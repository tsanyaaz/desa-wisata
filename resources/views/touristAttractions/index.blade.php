                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a class="btn btn-success rounded-pill" href="/touristAttractions/create"><i class="fas fa-user-plus"></i> Tambah Objek Wisata</a>
                        ...
                        <div class="card-body">
                            ...
                            @if (Session::has('page') && strpos(Session::get('page'), 'search') !== false)
                                <div class="mt-3">
                                    <a href="/touristAttractions" class="btn btn-secondary">Kembali</a>
                                </div>
                            @endif
                        </div>
                        <!-- /.card-body -->
